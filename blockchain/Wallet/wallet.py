...
def create_address(network='kuranet', xpub=None, child=None, path=0):
...
def get_network(network='kuranet'):
    ...
    if network == "bitcoin_testnet" or network == "btctest":
        ...
        return QtumTestNet
    elif network == "kuranet" or network=="kura_net":
        return KuraNet
    return KuraNet


def create_wallet(network='kuranet', seed=None, children=1):
    if seed is None:
