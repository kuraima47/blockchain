...
from kademlia.utils import decode_hex, encode_hex
...
def test_ping_pong_udp():
    ...
    gevent.sleep(0.1)
    bob_node = alice_discovery.protocol.get_node(
        bob_discovery.protocol.pubkey, bob_discovery.address
    )
...
def test_bootstrap_udp(kademlia_timeout):
    ...
    kademlia_timeout.k_request_timeout = 10000.0
